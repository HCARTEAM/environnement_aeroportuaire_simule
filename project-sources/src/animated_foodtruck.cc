  ...
  class AnimatedBox : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->model = _parent;
        ...
        key->Translation(ignition::math::Vector3d(-2.5, -48, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key = anim->CreateKeyFrame(19.63);
        key->Translation(ignition::math::Vector3d(-6.5, -42.9, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, -1.37));

        key = anim->CreateKeyFrame(34.65);
        key->Translation(ignition::math::Vector3d(-14.9, -1.67, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, -1.37));

        key = anim->CreateKeyFrame(39.175);
        key->Translation(ignition::math::Vector3d(-19, 3.16, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key = anim->CreateKeyFrame(41.315);
        key->Translation(ignition::math::Vector3d(-21, 3.16, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        key->Translation(ignition::math::Vector3d(-12.8, 3.16, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
