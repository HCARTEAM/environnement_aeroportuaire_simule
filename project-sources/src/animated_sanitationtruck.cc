...
namespace gazebo
{
  class AnimatedSanitationTruck : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      double Zpos(model->GetWorldPose().pos.z);
        ...
        gazebo::common::PoseAnimationPtr anim(
              new gazebo::common::PoseAnimation("animated_sanitationtruck", 398.8851, true));
  ...
  GZ_REGISTER_MODEL_PLUGIN(AnimatedSanitationTruck)
}
